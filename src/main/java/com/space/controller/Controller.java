...
public class Controller {
    ...
    public Integer getShipsCount(@RequestParam(value = "name", required = false) String name,
       ...
       return shipService.getShips(name, planet, shipType, after, before,
    ...
    public ResponseEntity<Ship> getShip(@PathVariable(value = "id") String shipId){
        final Long id = convertStringToLong(shipId);
    ...
    public ResponseEntity<Ship> deleteShip(@PathVariable(value = "id") String shipId){
        final ResponseEntity<Ship> entity = getShip(shipId);
    ...
    public ResponseEntity<Ship> createShip(@RequestBody Ship ship) {
        if (!shipService.isShipValid(ship)) return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<Ship> updateShip(
        ...
        final Ship savedShip = getShip(pathId).getBody();

        if (savedShip == null) return getShip(pathId);
    ...
    private Long convertStringToLong(String line){
